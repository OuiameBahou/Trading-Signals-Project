...
const Dashboard = ({ summary, isLoading, onNavigate }) => {
    ...
    const kpis = [
        ...
        { label: 'Granger Precedence', value: summary?.granger_significant ?? null, sub: 'Significant GC relations', icon: Zap, accent: '#a855f7', delay: 0.1 },
        { label: 'Triple Validated Pairs', value: summary?.official_pairs ?? null, sub: 'Confirmed by Lag + Granger + VAR', icon: Target, accent: '#C8102E', delay: 0.15 },
        { label: 'Top Leader', value: formatAsset(summary?.top_leader) ?? null, sub: summary?.top_leader_count ? `Leads ${summary.top_leader_count} assets` : 'Highest market centrality', icon: Award, accent: '#FFB81C', onClick: () => onNavigate('network'), delay: 0.2 },
                ...
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <p className="text-[11px] font-bold t-text-m uppercase tracking-[0.3em] mt-1 transition-colors">
                            Lead-Lag Analytics Platform · Attijariwafa Bank
                        </p>
                    </div>
                </div>
            ...
            >
                    ...
                    <table className="w-full text-left">
                        <thead className="text-[10px] t-text-m uppercase tracking-widest t-elevated t-border border-b font-bold transition-colors">
                            <tr>
                                ...
                                <th className="px-4 py-3 text-center">Granger F</th>
                        ...
                        <tbody className="divide-y t-border divide-y t-card transition-colors">
                            {pairsLoading ? (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3 text-center font-mono text-purple-400 font-bold text-sm">
                                        {(pair.Granger_Fstat || 0).toFixed(1)}
                                    </td>
                ...
                <div className="px-8 py-5 t-elevated t-border border-t flex flex-wrap items-center gap-x-10 gap-y-3 transition-colors">
                    <div className="flex items-center gap-2.5">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-widest t-text-m transition-colors">Lag Correlation &gt; 0.35</span>
                    </div>
                    <div className="flex items-center gap-2.5">
                        <Zap size={13} className="text-purple-400" />
                        <span className="text-[10px] font-bold uppercase tracking-widest t-text-m transition-colors">Granger F-Stat &gt; 20.0</span>
                    </div>
                    <div className="flex items-center gap-2.5">
                        <GitBranch size={13} className="text-emerald-400" />
                        <span className="text-[10px] font-bold uppercase tracking-widest t-text-m transition-colors">VAR FEVD Impact &gt; 0.20</span>
                    </div>
                </div>
            </motion.div>
