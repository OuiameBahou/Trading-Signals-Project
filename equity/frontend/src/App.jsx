...
import NlpTickerSentiment from './pages/NlpTickerSentiment';
import SentimentCorrelation from './pages/SentimentCorrelation';
...
const App = () => {
  ...
  const renderPage = () => {
    switch (activePage) {
      ...
      case 'nlp-sentiment': return <NlpTickerSentiment />;
      case 'nlp-correlation': return <SentimentCorrelation />;
      default:
        return (
