  ...
  if (loading) return (
    <div className="h-full flex items-center justify-center">
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="text-[10px] font-black t-text-m uppercase tracking-widest">Loading Equity Market Data…</div>
      </div>
    </div>
  );
        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            <h2 className="text-3xl font-black t-text uppercase transition-colors">
              Equity Indices <span style={{ color: '#FFB81C' }}>Platform</span>
            </h2>
            <p className="text-[11px] font-bold t-text-m uppercase tracking-[0.3em] mt-1 transition-colors">
              Algorithmic Equity Indices Strategy &amp; Regime Platform
            </p>
          </div>
        </div>
